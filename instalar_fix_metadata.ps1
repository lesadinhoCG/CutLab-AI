...
$Backup = Join-Path $Project ("backup_cutlab_metadata_" + $Stamp)
...
Write-Host ""
Write-Host "FIX DE METADADOS INSTALADO." -ForegroundColor Green
Write-Host "Backup: $Backup" -ForegroundColor Yellow
Write-Host ""
Write-Host "Reinicie o servidor e pressione Ctrl+F5." -ForegroundColor Cyan
